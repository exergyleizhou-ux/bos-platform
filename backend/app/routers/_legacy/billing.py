    ...
    return {
        ...
        "usage": {
            "users": {
                ...
                "pct": round(user_count / max(tenant.max_users, 1) * 100, 1),
            },
            "batches": {
                "current": batch_count,
                "limit": tenant.max_batches,
                "pct": round(batch_count / max(tenant.max_batches, 1) * 100, 1),
            },
            "calculations": {
                "current": calc_count,
                "limit": tenant.max_calculations,
                "pct": round(calc_count / max(tenant.max_calculations, 1) * 100, 1),
            },
        },
    }
